...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
					...
					<div class="modal-body" id="modalBody">
						...
						<div class="modal-body-techStacks">
							...
							<div class="row">
								<div class="col-12 modal-body-techStacks-tech">
									<!-- <img src="" name="am_upload_img" id="am_upload_img" class="img-thumbnail" style="width: 300px; height: 300px;"/> -->
									<!-- 이름 값에 따른 이미지를 보여주기 -->
								</div>
							</div>
						...
						<div class="modal-body-experience-edu">
							...
							<div class="row">
								<div class="col-5 modal-body-experience-edu-image">
									<img src="" name="edu_upload_img" id="edu_upload_img" class="img-thumbnail" style="width: 300px; height: 300px;"/>
								</div>
								<div class="col-6">
									<input type="text" value="" name="edu_title" id="edu_title" class="modal-body-experience-edu-title form-control" disabled="disabled"/>
									<textarea name="edu_contents" id="edu_contents" class="modal-body-experience-edu-contents form-control" rows="8" disabled="disabled"></textarea>
								</div>
							</div>
						</div>
						<div class="modal-body-experience-prj">
							...
							<div class="row">
								<div class="col-6 ml-auto">
									...
									<textarea name="prj_contents" id="prj_contents" class="modal-body-experience-prj-contents form-control" rows="8" disabled="disabled"></textarea>
								</div>
								<div class="col-5 modal-body-experience-prj-image">
									<img src="" name="prj_upload_img" id="prj_upload_img" class="img-thumbnail" style="width: 300px; height: 300px;"/>
								</div>
							</div>
						</div>
